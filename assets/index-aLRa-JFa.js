...
aut aut aut maxime quia temporibus ut omnis`}];function Dc(e){return Mc.find(t=>t.id===e||null)}function jc(e){return Rc.filter(t=>t.postId===e)}const Oc=Tc.map(e=>({...e,user:Dc(e.userId),comments:jc(e.id)})),Fc=()=>R.jsxs("section",{className:"App",children:[R.jsx("h1",{className:"App__title",children:"Static list of posts"}),R.jsx(Lc,{posts:Oc})]});em(document.getElementById("root")).render(R.jsx(Fc,{}));
